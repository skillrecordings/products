      ...
      {neutral ? (
        <div className="pt-10 prose prose-lg text-center sm:prose-xl dark:prose-dark">
          {isLast ? (
            <p tabIndex={-1} ref={answeredMessageRef}>
              {srMessage}
              This was the last lesson from the {title} email course. We hope
              you learned something new, and we look forward to sharing more in
              the future!
            </p>
          ) : (
            <p tabIndex={-1} ref={answeredMessageRef}>
        ...
        <div className="pt-10 mt-10 prose prose-lg text-center border-t border-gray-200 sm:prose-xl dark:prose-dark dark:border-gray-700">
          ...
          {isLast ? (
            <p>
              This was the last lesson from the {title} email course. We hope
              you learned something new, and I look forward to sharing more in
              the future!
            </p>
          ) : (
