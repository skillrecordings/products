  ...
  <mj-body background-color="${backgroundColor}">
    <mj-section padding="10px 0 10px 0">
      <mj-column background-color="${backgroundColor}">
        <mj-image alt="${process.env.NEXT_PUBLIC_SITE_TITLE}" width="180px" src="https://res.cloudinary.com/testing-accessibility/image/upload/v1655584147/logo-email_2x_e0n8tn.png" />
      </mj-column>
    </mj-section>
    <mj-section padding-top="0">
      <mj-column background-color="${mainBackgroundColor}" padding="16px 10px">
        <mj-text font-size="18px" color="${textColor}" align="center" padding-bottom="20px">
          Log in as <strong color="${textColor}">${escapedEmail}</strong> to ${process.env.NEXT_PUBLIC_SITE_TITLE}.
        </mj-text>
