...
The app will be served at `http://localhost:3019`.
...
The `dev:stripe` node script is a shorthand for `stripe listen --forward-to localhost:3019/api/skill/webhook/stripe`.
