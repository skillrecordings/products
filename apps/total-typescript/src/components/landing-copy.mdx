...
<div className='md:h-32 h-20 bg-gradient-to-b from-background to-[#191427] w-full' />
...
<div className="relative z-10 overflow-x-hidden">
  <div className="md:pt-24 md:pb-64 pt-0 pb-16">
...
- Pro Essentials (17 sections, 200+ exercises)
...
<Module
  ...
  metaLabel="over 200 lessons"
  sub="Learn TypeScript by setting up a pro environment, using advanced IDE features, and mastering type annotations, unions, object types, inference, and generics."
