...
<div className="relative z-10 overflow-x-hidden">
  <div className="md:pt-32 md:pb-64 pt-0 pb-16">
...
**You never learned the underlying principles and patterns of being an effective TypeScript engineer.**
  ...
  <Image alt="sea of red lines" aria-hidden="true" src={SeaOfRedLines} fill className="object-top object-contain mix-blend-lighten z-0" />
</section>
...
<div className='not-prose flex w-full flex-col items-center'>
  <Image aria-hidden="true" src={HandPointingDownSparkles} alt="hand pointing down with sparkles" width={512} height={633} className="mx-auto -mt-10" />
...
<Image src={Cauldron} alt="a cauldron with TS written on it" width={400} height={400} aria-hidden="true" className="md:absolute md:mt-0 -mt-48 xl:max-w-full sm:max-w-[300px] mx-auto max-w-[300px] right-0 xl:-top-40 sm:-top-32 md:-rotate-12" />
<div className=''>
