...
Total TypeScript is great both for beginners, and for those already familiar with TypeScript. Our [Pro Essentials](/workshops/typescript-pro-essentials) course covers material from beginner to intermediate, and the [other workshops](/workshops) cover advanced content.
