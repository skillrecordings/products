# Total TypeScript Frequently Asked Questions
...
No. You will have to purchase each volume separately. This is not a membership or subscription.
...
Total TypeScript self-paced workshops are meant for experienced developers familiar with TypeScript and wanting to go deeper. Less experienced developers are encouraged to explore the Beginner's Tutorial first.

## What if I've been working with and studying TypeScript for years?

You'll still learn something! Total TypeScript pro workshops dig deep and provide interactive exercises to help you master TypeScript.
...
The course is up to date and compatible with TypeScript v4.8+
