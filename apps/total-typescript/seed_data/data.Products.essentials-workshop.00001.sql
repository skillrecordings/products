...
('tt_product_clxeui5j7000008iebmqm95rz', 'TypeScript Pro Essentials', 'self-paced',1);

INSERT INTO Price (id, productId, nickname, status, unitAmount ) VALUES
('tt_price_a805bc8b-b0a1-4e53-8653-696be7a6b549', 'tt_product_clxeui5j7000008iebmqm95rz', 'TypeScript Pro Essentials', 1, 250);

INSERT INTO MerchantProduct (id, merchantAccountId, productId, status, identifier) 
VALUES ('tt_merchant_product_137e3deb-20bd-4879-bbce-ded76a679f70', 'tt_cc7acfa7-f60b-4315-ae51-3cbd305e23ae', 'tt_product_clxeui5j7000008iebmqm95rz', 1, 'prod_PtXc4OPWrQgjgM');
