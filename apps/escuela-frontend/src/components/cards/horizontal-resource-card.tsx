...
const HorizontalResourceCard: React.FC<
  React.PropsWithChildren<HorizontalResourceCardProps>
> = ({resource, location, className = 'p-5 sm:p-8 ', ...props}) => {
    ...
    <Link href={resource.path}>
      <a>
        <div {...props} className={className}>
          <div className="flex flex-col justify-between h-full gap-4 spac">
            {resource.tag && (
              <span>
                <Image
