...
import {type Lesson, LessonSchema} from 'lib/lessons'
...
> = ({
  ...
  const nextLesson = getNextLesson(module, lesson as Lesson)
  ...
  const handleNext = React.useCallback(
    (autoPlay: boolean) => {
      nextLessonSlug && autoPlay
        ? router.push({
            pathname: '/[module]/[lesson]',
            query: {module: moduleSlug, lesson: nextLessonSlug},
          })
        : setDisplayOverlay(true)
    },
    [moduleSlug, nextLessonSlug, router],
  )
