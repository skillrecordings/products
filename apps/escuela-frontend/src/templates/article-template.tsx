...
const Header: React.FC<SanityDocument> = ({
  ...
  return (
    <header className="relative flex flex-col items-center px-5 pt-24 pb-8 overflow-hidden text-white bg-slate-800/40">
      <div className="relative z-10 flex flex-col items-center w-full max-w-screen-lg mx-auto">
        <Link passHref href="/articles">
          <a className="relative px-4 py-2 text-base font-normal text-white transition bg-white bg-opacity-0 rounded-lg sm:text-lg group hover:text-white hover:bg-opacity-10 opacity-80 hover:opacity-80 focus-visible:ring-white focus-visible:opacity-100">
...
const Signature = () => {
  return (
    <svg
      aria-hidden="true"
      className="mt-8 w-28 text-slate-300"
      viewBox="0 0 102 55"
      fill="none"
