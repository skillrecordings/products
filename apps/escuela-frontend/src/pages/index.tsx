      ...
      <header className="relative z-0 -mt-40 ">
        ...
        >
          <div className="z-10 flex h-full w-full flex-col items-center justify-center">
            <h1 className="mx-6 mt-12 mb-4 w-[400px] bg-gradient-to-b from-white to-gray-200 bg-clip-text text-center font-heading text-2xl font-extrabold leading-tight text-transparent sm:text-3xl md:!w-full md:text-5xl lg:text-6xl ">
              Domina el Universo Front-End
            </h1>
            <p className="font-space-grotesk mx-6 max-h-[112px] w-[350px] text-center text-xl text-gray-200 md:max-h-[96px] md:w-[630px] md:text-2xl">
