...
<div className="pt-8 sm:pb-8 pb-8 text-center lg:-mx-16">
  <div className="font-display sm:text-3xl text-2xl text-brand-cream max-w-2xl mx-auto">
...
<div className="pt-8 sm:pb-8 pb-8 text-center">
  <div className="font-display flex flex-col space-y-1 sm:text-3xl text-2xl text-brand-cream max-w-2xl mx-auto">
    <span className="text-[#FF7863]">Rapid pRotoTyping</span>{' '}
    <span className="">creating more accessible websites</span>{' '}
    <span className="text-brand-brightYellow">enhanced user expeRience</span>{' '}
    <span className="">MoRe advanced capabilties</span>{' '}
    <span className="text-[#88dac6]">More job opPortuniTies</span>{' '}
  </div>
</div>
