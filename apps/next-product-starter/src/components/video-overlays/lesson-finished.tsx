        ...
        {nextResource && (
          <>
            <p className="tabular-nums">
              ...
              {!canceled && (
                <>
                  in {seconds <= DURATION ? (seconds - DURATION - 1) * -1 : ''}
                  <button
                    className="p-2"
                    onClick={() => {
                      setCanceled(true)
                  ...
                  >
                    ...
                    >
                      ...
                      <g fill="currentColor">
                        <rect x="8" width="4" height="12" rx="0.5"></rect>
                        <rect
                          width="4"
                          height="12"
                          rx="0.5"
            ...
            <div>
              ...
              <div className="flex gap-2 w-full max-w-lg">
                <button
                  className="bg-white gap-2 bg-opacity-5 p-3 rounded-sm inline-flex w-full items-center justify-center"
                  onClick={() => {
                    // setCanceled(true)
                    videoService.send('PLAY')
                ...
                <button
                  className="bg-white bg-opacity-20 p-3 rounded-sm inline-  flex w-full items-center justify-center"
                  onClick={() => {
                    router.push(`/video/${nextResource.slug}`).then(() => {
                      videoService.send('PLAY')
                    })
