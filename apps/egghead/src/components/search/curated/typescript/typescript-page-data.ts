    ...
    resources: [
      {
        ...
        path: '/courses/build-custom-command-line-interface-cli-tooling-with-oclif-and-typescript',
        image:
    ...
    resources: [
      {
        ...
        path: '/playlists/build-a-blog-with-next-js-typescript-emotion-and-netlify-adcc',
        image:
    ...
    resources: [
      {
        ...
        path: '/lessons/typescript-implement-the-heapsort-algorithm-using-typescript-javascript',
        image:
          'https://d2eip9sf3oo6c2.cloudfront.net/series/square_covers/000/000/128/thumb/EGH_TS-Algorithms.png',
        byline: 'Basarat Ali Syed',
      },
