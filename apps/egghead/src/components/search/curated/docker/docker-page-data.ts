const nodePageData = [
  {
    ...
    image: {
      src: 'https://d2eip9sf3oo6c2.cloudfront.net/playlists/square_covers/000/410/102/full/egh_intro-to-docker.png',
      alt: 'Stylized illustration of colorful shipping containers with a docker logo',
    },
