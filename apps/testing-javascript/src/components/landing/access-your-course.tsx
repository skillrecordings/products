    ...
    <section className={cx(className)}>
      <div className="container max-w-6xl mb-20">
        <div className="space-y-6 text-lg">
          <h2 className="text-3xl md:text-4xl font-tt-regular">
            Access your <span className="font-tt-demibold">{title}</span>{' '}
            course.
          </h2>
          <p>
            ...
            <a
              ...
              className="border-b-2  border-tjs-yellow hover:bg-tjs-yellow duration-200"
            >
              Click here if you have not yet connected your TestingJS account to
              Discord
            </a>
            .
          </p>
        ...
        <div className="flex justify-center mt-10">
          <Link
            href="/"
            className="space-x-4 inline-flex items-center bg-gray-100 text-black px-6 py-2 rounded-md mt-7 hover:bg-gray-200 duration-100 min-h-[50px] border-gray-200 border"
          >
