          ...
          >
            {error ? (
              <>
                ...
                <h2 className="text-2xl font-semibold mt-8 leading-tight text-center">{error}</h2>
              ...
              <>
                ...
                <p className="my-4 text-center text-base">
                  Enter your email address that will be used to log in to Pure React and access the
                  content. Please double check that it is correct.
                </p>
                <Formik
                  initialValues={{ email: '' }}
