...
const CompletedMessage: React.FC<{
  ...
  return neutral ? (
    ...
    <div className="font-medium prose sm:prose-xl prose-lg pt-10 border-t border-gray-200 mt-10 text-center">
      <p>
        You didn't answer correctly, but don't worry. Just go back and re-read the email and check
        out any linked resources. You can refresh the page if you'd like to try again! 👍
      </p>
