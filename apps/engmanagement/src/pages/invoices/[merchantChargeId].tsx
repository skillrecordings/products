...
> = ({charge, product, merchantChargeId}) => {
  ...
  const instructorName = 'Sarah Drasner'
  const productName = `Engineering Management for the Rest of Us ${instructorName}`
          ...
          <div className="px-10 py-16">
            ...
            <table className="table-auto w-full text-left">
              ...
              <tbody>
                ...
                <tr className="table-row">
                  <td>
                    Engineering Management for the Rest of Us ({product.name})
                    {/* {date} */}
                  </td>
                  <td>
