            ...
            .map((purchase: Purchase | any) => {
              return (
                <li key={purchase.merchantChargeId}>
                  <div className="flex sm:flex-row flex-col justify-between sm:items-center bg-gray-800 p-5 rounded-md shadow-sm">
                    <div className="flex gap-2 w-full">
                      ...
                      <div>
                        <h2 className="text-lg font-semibold leading-tight">
                          Engineering Management ({purchase.product.name}){' '}
                        </h2>
                    ...
                    <Link href={`/invoices/${purchase.merchantChargeId}`}>
                      <a className="sm:mt-0 mt-5 flex-shrink-0 text-orange-300 font-medium flex items-center sm:justify-center justify-end rounded-md px-3 py-2 hover:bg-moss-50 hover:bg-opacity-60 transition text-sm">
