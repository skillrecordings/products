...
export const ThingsToUnderstand = () => {
  return (
    <div className="not-prose">
      <ul className="md:py-10 py-2 max-w-screen-md mx-auto list-outside list-none pl-0 grid md:grid-cols-2 grid-cols-1 place-content-center place-items-start sm:text-xl text-lg md:gap-16 gap-5">
