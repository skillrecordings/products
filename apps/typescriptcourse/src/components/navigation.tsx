...
const Navigation: React.FC<NavigationProps> = ({title = 'Product'}) => {
  return (
    <nav
      ...
      className="w-full flex items-center justify-between print:hidden sticky top-0 left-0 z-20 p-2 border-b border-gray-800 bg-gray-900 supports-backdrop-blur:backdrop-blur-lg supports-backdrop-blur:bg-opacity-70 bg-opacity-95"
    >
