...
export const meta = {
  ...
  url: config.siteUrl,
  ogImage: config.openGraph.images.default,
  ...
  formSubHeadline: 'Your quick-start guide to TypeScript',
}
...
export const emailCourses = [
  ...
  {
    title: 'Learn How to Navigate a TypeScript Codebase Effectively',
    description:
    ...
    <div className="sm:px-0 px-5 group transition ease-in-out duration-200 not-prose flex flex-col justify-between relative">
      <div className="flex sm:flex-row flex-col sm:gap-10">
        ...
        <div>
          ...
          <div className="text-base pt-4 pb-7 opacity-80 leading-relaxed">
