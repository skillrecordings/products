...
export const meta = {
  ...
  headline: 'Learn How to Build Cutting-Edge <span className="bg-gradient-to-l from-white to-blue-300 bg-clip-text text-transparent decoration-clone">Typescript Projects</span> From Scratch',
