...
export const meta = {
  ...
  headline:
    'Build a TypeScript Project <span className="bg-gradient-to-l from-white to-blue-300 bg-clip-text text-transparent decoration-clone">From Scratch</span>',
  description: config.description,
  titleAppendSiteName: false,
  url: config.siteUrl,
  headerImage: require('../../public/images/emails/build-ts-project-from-scratch/icon.svg'),
  ogImage: {
