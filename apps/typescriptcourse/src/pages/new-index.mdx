...
<section className="bg-gradient-to-b from-black to-transparent bg-opacity-75 border-t border-gray-800 mt-24 pb-8">
...
<CheckList className="mb-16 max-w-screen-sm mx-auto">
...
<h2 className="text-center pb-10">
  This is a learning environment that optimizes{' '}
  <Annotation type="underline" multiline strokeWidth={6} padding={0}>
...
<p className="text-center pb-5">
  <Annotation type="underline" strokeWidth={2}>
...
export const Card = ({resource, idx}) => {
  ...
  return (
    <div className="group transition ease-in-out duration-200 not-prose flex flex-col justify-between relative">
      <div className="flex gap-10">
        <div className="flex justify-center flex-shrink-0">
          <Image src={image} height={150} alt={title} />
        </div>
        <div>
          <p className="text-2xl font-bold font-heading pt-8 inline-flex">
            {title}
          </p>
