    ...
    <Layout className="bg-white">
      <div>
        <div className="flex flex-col justify-between min-h-screen overflow-hidden">
          <header className="relative text-white bg-green-700 lg:pt-24 sm:pt-24 pt-20 bg-noise">
            <div className="flex flex-col items-center justify-center w-full">
              <div className="flex flex-col items-center justify-center text-center px-8">
                <h1 className="md:max-w-screen-lg lg:text-5xl md:text-5xl sm:text-4xl text-4xl font-heading font-bold lg:leading-tight max-w-lg">
                  <span className="inline-flex">
                    Comprehensive Accessibility Training for Shipping
                    High-Quality Web Applications
                  </span>{' '}
                  <span className="lg:leading-relaxed max-w-screen-sm font-sans inline-block font-normal pt-8 sm:text-xl text-center text-moss-200">
              ...
              <div className="sm:translate-y-32 translate-y-24 drop-shadow-2xl sm:w-auto -mt-24">
                <Image
