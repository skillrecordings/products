...
For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at team@testingaccessibility.com

import Layout from 'components/app/layout'

export default ({children}) => (
  <Layout meta={{title: 'Terms & Conditions'}}>
    <main className="p-5 lg:py-32 sm:py-24 py-16">
