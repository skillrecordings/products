...
<div className="prose-blockquote:text-sand-700 w-full flex items-center justify-center prose-blockquote:border-none font-heading text-3xl prose-blockquote:font-bold max-w-md mx-auto text-center">
