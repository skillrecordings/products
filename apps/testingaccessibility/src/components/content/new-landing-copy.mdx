...
**If your applications aren’t usable by all users, your job isn’t done.**

It is your responsibility for delivering high-quality applications that work as expected for all users.
...
**Each of these areas brings with them its own set of challenges:**
...
<Section className="bg-sand-50" image="https://res.cloudinary.com/testing-accessibility/image/upload/v1652193641/01-manual-testing/05-screen-reader-testing/illustration-screen-reader-testing_2x_ijgk3q.png">

## A Repeatable, Well-Defined Processes for Accessibility Testing

Get accessibility buy-in from stakeholders and colleagues through effective manual and automated testing plans.

Identify the highest value user flow in your application.
...
Write focused unit tests for every interactive control involved in the user flow to ensure they meet industry-standard accessibility guidelines.
...
Not just for the people who use your web application, but in your career as well.
...
What if your team could identify and remediate every accessibility issue in an application and prevent them from happening again?
...
<Section className="bg-green-700 bg-noise text-white prose-headings:text-white" image="https://res.cloudinary.com/testing-accessibility/image/upload/v1652193540/01-manual-testing/02-keyboard-testing/illustration-keyboard-testing_2x_k3sjqm.png">
...
<Steps
  data={[
    ...
    },
    {
      ...
      children:
        'Properly use semantic elements and ARIA. Understand methods of hiding elements with CSS and when to use which. Programmatically supply accessibility information to screen readers.',
    },
  ]}
/>
...
<Section className="bg-moss-50 prose-green" image={require('../../../public/assets/lighthouse@2x.png')}>
...
The reality is that designs that we are given to implement don't always cover all of the aspects of what makes an application accessible. There’s an art to evaluating visual designs and mockups for potential issues.
...
It is critical that you can provide detailed explanations to ensure the collaborative design process is as inclusive as possible.
...
There’s more to accessibility than just adding some attributes to your tags. The Americans with Disabilities Act put it best:

<div className="prose-blockquote:pl-0 prose-blockquote:px-5 prose-blockquote:text-sand-700 w-full flex items-center justify-center prose-blockquote:border-none font-heading text-3xl prose-blockquote:font-bold max-w-md mx-auto text-center">
...
Just because a pattern is popular doesn’t mean it has been implemented accessibly.
...
<Section className="pb-14 sm:pb-20" image="https://res.cloudinary.com/testing-accessibility/image/upload/v1652193608/01-manual-testing/04-magnification-and-zoom-testing/illustration-magnification-and-zoom-testing_2x_gqjsx7.png">
...
<Section className="bg-sand-50 pt-10 pb-24">
...
<PlansGrid
  columns={[
    ...
    },
    {
      title: 'Build',
      children: [
        'Structure the correct elements and attributes to enable the best possible experience for screen readers and other assistive technology users.',
      ],
    },
    {
      title: 'Test',
...
<div className="border-b border-sand-50">
  <div className="not-prose flex items-center justify-center w-full max-w-screen-md mx-auto">
    <AboutMarcy />
  </div>
</div>

<Section className="sm:pb-24 pb-16 pt-8">

## 6 Workshops Designed to Maintain a Focus on Accessibility No Matter Where You Are in The Development Process

The six self-paced workshops in Testing Accessibility are a hybrid of carefully crafted text instruction, supporting video, and learning challenges with worked-out solutions.
...
It’s just like attending a live workshop, but with the benefit of learning on your own time. No more timezones or scheduling difficulties– learn as you have the time.

Just because the workshops are self-paced doesn’t mean they’re just passive reading. It is designed to put you in the driver's seat and challenge you to do the work. Each module contains carefully crafted learning challenges that will help you cement your learning.
...
Identifying missing image alt attributes with a linter in VSCode, troubleshooting page landmarks with a browser extension, and managing roving `tabindex` with React’s `useState` hook are just a few examples of the things you’ll experience in the workshop.
