...
<section className="bg-sand-50 pb-56 mt-56 prose-p:text-sand-900 prose-headings:text-sand-900 relative sm:pt-48 pt-16">
...
<h2 className="lg:text-5xl text-4xl lg:mt-8 mt-4">Start with a design</h2>
...
<section className="bg-moss-100 pb-24 prose-teal">

<div className="flex items-center justify-center w-full -mt-40 md:px-0 px-16">
  <Image
