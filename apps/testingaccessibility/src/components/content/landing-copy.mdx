...
<Testimonial author="J. Decker, Director of Product Strategy/Accessibility Lead" avatar={require('../../../public/testimonials/jona-decker.jpeg')} className="bg-sand-100 border-l-4 border-sand-400 mt-16" iconClassName="bg-sand-500">
...
<Testimonial author="Gerardo Rodriguez, Senior Front End Developer" avatar={require('../../../public/testimonials/gerardo-rodriguez.jpeg')} className="bg-sand-100 border-l-4 border-sand-400 text-sand-900 mt-16" iconClassName="bg-sand-500">
...
<Testimonial author="Desiree Bradish, Software Developer" avatar={require('../../../public/testimonials/desiree-bradish.jpeg')} className="bg-moss-600/50 border-l-4 border-amber-300 mt-20 text-sand-100" iconClassName="bg-amber-300 text-black">
...
<Section ariaLabel="Testing workflow tips" className="pb-14 sm:pb-20" padding={false} image="https://res.cloudinary.com/testing-accessibility/image/upload/v1652193608/01-manual-testing/04-magnification-and-zoom-testing/illustration-magnification-and-zoom-testing_2x_gqjsx7.png">
