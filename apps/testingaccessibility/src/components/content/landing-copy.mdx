...
<section className="bg-[#FAF4F1] pb-56 mt-56 prose-p:text-[#261206] prose-headings:text-[#261206] relative sm:pt-48 pt-16">
...
<section className="bg-[#E9EBE2] pb-24 prose-teal">
