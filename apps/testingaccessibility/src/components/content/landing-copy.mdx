...
<section className="bg-sand-50 pb-56 mt-56 prose-p:text-sand-700 prose-headings:text-sand-800 relative sm:pt-48 pt-16">
...
<section className="bg-moss-100 pb-24 prose-teal sm:pt-40 pt-16 relative">
<div className="flex items-center justify-center w-full absolute -top-40 md:px-0 px-16">
  <Image
