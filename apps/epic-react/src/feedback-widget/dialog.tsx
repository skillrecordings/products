    ...
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed left-1/2 top-1/2 z-50 max-h-[85vh] w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-lg border border-gray-800 bg-gray-900 p-5 shadow-2xl shadow-black/50"
        >
          <CloseButton
            ref={closeButtonRef}
