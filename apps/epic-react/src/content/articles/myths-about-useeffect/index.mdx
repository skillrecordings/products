...
socialImage: 'https://epicreact.dev/myths-about-useeffect/card@2x.png'
...
![User clicks "Bernedoodle" link and information about a Bernedoodle shows up, then the user clicks "Poodle" and poodle info shows up. Then back to "Bernedoodle", then "Bernese Mountain Dog", then "return to list"](./dogs.gif)
...
![A geochat app showing location based chat, autoscroll, and unread count in the document title](./geo-chat.gif)
