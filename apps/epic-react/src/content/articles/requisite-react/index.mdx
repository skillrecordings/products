...
![Faucet with the head not retracting into the neck](./broken-faucet.png)

The head of the faucet wouldn't automatically go back into the neck! And we
couldn't even push it back in. It just hung there. Like a sad flower 🥀
...
![Under a sink a faucet hose is tangled in itself](./tangled-hose.png)
...
![Under a sink a faucet hose is untangled](./untangled-hose.png)
...
ego. The embarrassment would have been too much 🙈
...
(and that's just the way my mechanic likes it 🤑).
