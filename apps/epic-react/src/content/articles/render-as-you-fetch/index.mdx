...
![User clicks "pikachu" and after a loading delay, pikachu's data and photo is displayed](./interaction.gif)
...
![A DevTools Screenshot showing a waterfall of requests](./bad.png)
...
![A DevTools Screenshot showing all the same requests from the previous image except they all start at the same time](./good.png)
