...
<div className="sm:px-10 px-6 sm:py-5 py-2 bg-gray-100 sm:rounded-md sm::-mx-10 -mx-8 text-black">
  ...
  Epic React is a complete end-to-end series of self-paced workshops from Kent C. Dodds. Every module in Epic React is produced from multiple live in person events and have been used to learn React by 30,000+ developers.
