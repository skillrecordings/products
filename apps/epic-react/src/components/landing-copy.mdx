...
## React is the smart choice for most web development projects in 2024
...
<Image
  src={require('../../public/assets/spot.png')}
  alt=""
  className="mx-auto"
  width={320}
  height={320}
...
- **18 hours of concise in-depth video training**
...
<section className='flex sm:items-start items-center sm:flex-row flex-col sm:gap-10'>
