        ...
        !MODULES_WITH_NO_CERTIFICATE.includes(module.slug.current) && (
          <div className="relative mt-8 bg-background">
            <Dialog.Root>
              ...
              >
                {/* prettier-ignore */}
                <svg className='mr-2 text-text' width='18' height='18' viewBox='0 0 20 20'
