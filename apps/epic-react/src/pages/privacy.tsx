...
const PrivacyPage = () => (
  <Layout
    meta={{
      title: 'Terms, Conditions, and Privacy Policy for Epic React',
    }}
  >
    <main className="p-5 py-10 lg:py-16">
      <article className="prose mx-auto dark:prose-invert prose-headings:text-balance prose-h1:text-center">
...
This website is operated by Skill Recordings Inc. Throughout the site, the terms “we”, “us” and “our” refer to Skill Recordings Inc. Skill Recordings Inc. offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
...
Our storefront is created with Next.js and served on Vercel. They provide us with the online platform that allows us to sell our products and services to you.
