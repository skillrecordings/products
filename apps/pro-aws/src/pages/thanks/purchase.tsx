    ...
    <header className="flex w-full flex-col items-center justify-center">
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center pt-8 text-center">
          <h1 className="max-w-sm font-heading text-lg font-medium sm:text-xl lg:text-2xl">
            <span className="block pb-2 font-heading text-sm font-black uppercase text-primary dark:text-emerald-300">
              Success!
            </span>
