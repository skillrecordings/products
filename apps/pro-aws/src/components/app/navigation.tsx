...
export const Logo: React.FC<{className?: string}> = ({className}) => {
  return (
    <div className="flex h-20 w-20 flex-col items-start justify-end border-r pb-3 pl-3 font-heading text-xl font-medium leading-none transition hover:bg-border/50">
