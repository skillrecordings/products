...
<Blockquote class="twitter-tweet">
  <p lang="en" dir="ltr">
    ...
    for keeping the lights on.) Super thankful to y’all. We’re working to turn
    it into a real product soon™. Hope you’ll enjoy.
    <a href="https://t.co/xZSxNI4nqD">pic.twitter.com/xZSxNI4nqD</a>
  </p>
  &mdash; дэн (@dan_abramov)
...
<Blockquote class="twitter-tweet">
  <p lang="en" dir="ltr">
    The “email sequence train” model where each subscriber gets emails one by
    one (like we do on
    ...
    until I’m happy with responses. Continuous delivery.
  </p>
  &mdash; дэн (@dan_abramov)
...
<div className="grid sm:grid-cols-2 grid-cols-1 gap-5">
  <Blockquote class="twitter-tweet">
    <p lang="en" dir="ltr">
      ...
      🍅💯 <a href="https://t.co/UJLKKeTyNV">pic.twitter.com/UJLKKeTyNV</a>
    </p>
  ...
  <Blockquote class="twitter-tweet">
    ...
    &mdash; Alvar Lagerlöf (@alvarlagerlof)
