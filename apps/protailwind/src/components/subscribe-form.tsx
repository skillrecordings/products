...
const NewsletterSubscribeForm = () => {
  ...
  return (
    <section
      ...
      className="relative flex flex-col items-center justify-center bg-blue-600 px-5 py-32 text-white"
    >
      ...
      <div className="relative flex w-full flex-col items-center justify-center">
        <div className="max-w-3xl pb-16 text-center">
          <h2 className="font-heading text-4xl font-black leading-tight sm:text-5xl sm:leading-tight">
            Level-up and ride the Tailwind CSS wave like a Pro
          </h2>
          <p className="pt-6 text-xl text-blue-100">
            Sign up for exclusive and early-access today!
          </p>
        </div>
        <SubscribeToConvertkitForm
