                ...
                {section?.items?.map((item: Item) => {
                  if (item.link) {
                    return (
                      <Link href={item.link} key={item.label}>
                        <a className="rounded-lg border-2 dark:hover:bg-gray-900 hover:bg-gray-100 dark:border-gray-900 border-gray-100 dark:bg-black bg-white text-3xl font-extrabold  py-24 flex items-center justify-center flex-col transition-colors duration-100 ease-in-out min-h-[300px]">
                          {item.label}
                        </a>
                      </Link>
                    )
                  ...
                  if (item.items) {
                    return (
                      <div
                        key={item.label}
                        className="rounded-lg border-2 dark:border-gray-900 border-gray-100 dark:bg-black bg-white text-2xl font-extrabold  py-16 flex items-center justify-center flex-col transition-colors duration-100 ease-in-out min-h-[300px]"
                      >
