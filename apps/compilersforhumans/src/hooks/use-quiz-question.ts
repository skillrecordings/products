...
import sendAnswerToAirtable from 'utils/send-to-airtable'
import {ConverkitContext} from 'contexts/convertkit-context'
...
function useQuestion(question: Question) {
  const subscriber = React.useContext(ConverkitContext)
