          ...
          >
            <Collection.Sections className="space-y-0 [&_[data-state]]:animate-none">
              {moduleProgressStatus === 'loading' ? (
                ...
                <Collection.Section className="border-b font-semibold leading-tight transition data-[state]:rounded-none data-[state='closed']:opacity-75 data-[state='closed']:hover:opacity-100 [&>[data-check-icon]]:w-3.5 [&>[data-check-icon]]:text-emerald-500 [&>[data-check-icon]]:opacity-100 dark:[&>[data-check-icon]]:text-emerald-300 [&>[data-progress]]:h-[2px] [&>[data-progress]]:bg-emerald-500 dark:[&>[data-progress]]:bg-gray-700">
