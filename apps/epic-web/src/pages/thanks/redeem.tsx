    ...
    <Layout>
      <main className="flex flex-grow flex-col items-center justify-center p-5">
        <div className="w-full max-w-screen-md">
          <h1 className="font-heading pb-5 text-3xl font-black text-black">
            Success!
          </h1>
        </div>
        <div className="bg-brand-red selection:text-brand-red relative mx-auto flex w-full max-w-screen-md items-center justify-between gap-5 overflow-hidden rounded-xl p-7 text-white shadow-2xl shadow-gray-400/20 selection:bg-white sm:p-12">
