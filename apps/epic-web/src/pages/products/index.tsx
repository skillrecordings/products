...
const ProductCard: React.FC<{
  ...
  const buyHref = `/products/${product.slug?.replace('workshops/', '')}` // isSingleModuleProduct ? `/products/${product.slug}` : '/buy'
  const purchasedHref = `/products/${product.slug?.replace('workshops/', '')}`
