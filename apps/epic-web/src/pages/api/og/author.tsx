    ...
    const DefaultTemplate = () => {
      return (
        <div
          ...
          style={{
            background:
              'linear-gradient(254deg, #23283A 1.81%, #0B132E 95.83%)',
          }}
        >
          <div tw="flex flex-row items-center w-full h-full pt-24 pb-24 relative px-24">
            ...
            {hasImage ? (
              <div
                tw="absolute flex right-16 rounded-full overflow-hidden"
                style={{width: 450, background: '#141C38'}}
              >
                <img src={image} />
              </div>
            ) : null}
