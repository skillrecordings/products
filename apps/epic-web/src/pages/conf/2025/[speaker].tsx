        ...
        <div className="flex w-full flex-col items-center gap-8 sm:flex-row sm:justify-between">
          <div className="flex items-end gap-8">
            ...
            <div className="flex flex-col items-start gap-5 md:flex-row">
              ...
              <div
                className={cn(
                  'relative z-10 hidden flex-col gap-3 pl-8 md:flex',
                  {
                    'border-l': !sponsor,
                  },
                )}
              >
                <span className="text-sm opacity-80">Dinner Sponsor</span>
                <div className="transition duration-200 ease-in-out hover:scale-105">
                  <Link
                    className="flex"
                    href="https://go.clerk.com/epicweb-conf"
                    target="_blank"
                  >
                    <svg
                      className="h-14"
    ...
    logo: (
      ...
      >
        ...
        >
          <path
            fill="currentColor"
            d="M193.71 67.665v83.459h-19.461V67.665l-5.614-5.614h-34.431v-17.59h99.551v17.59h-34.431l-5.614 5.614Zm113.103 67.74h25.823v15.719h-83.832v-15.719h31.437l4.865-4.864V92.367l-4.865-4.866h-31.437V71.783h53.144v58.758l4.865 4.864Zm105.819 8.422c-4.679 5.052-14.222 9.918-25.637 9.918-23.952 0-40.98-18.714-40.98-42.292 0-23.578 17.028-42.29 40.98-42.29 11.415 0 20.958 4.865 25.637 9.918h4.491v-7.11h19.087v74.475c0 26.011-21.707 42.479-47.905 42.479-18.712 0-33.496-5.989-42.852-16.094l11.415-13.473c7.485 8.047 20.023 13.286 31.437 13.286 18.152 0 28.818-9.73 28.818-25.262v-3.554l-4.491-.001Zm4.865-24.326v-16.094c-6.737-9.543-15.532-17.216-27.882-17.216-14.783 0-23.953 11.04-23.953 25.262 0 14.222 9.17 25.262 23.953 25.262 12.35 0 21.145-7.671 27.882-17.214Zm64.838 31.623h-19.087V36.416h19.087v44.349h4.49a34.147 34.147 0 0 1 25.637-11.602c18.713 0 32.185 11.414 32.185 32.56v49.401h-19.086V105.84c0-11.04-3.556-19.275-15.906-19.275-11.228 0-20.022 10.106-27.32 21.333v43.226Zm95.066-63.249h-18.713V71.783h23.391V44.462h19.274v27.32h39.297v16.093h-34.806l-4.678 4.678v21.707c0 13.66 5.053 22.268 18.151 22.268 11.602 0 18.338-6.174 26.385-16.84l11.415 13.099c-9.169 12.91-23.017 20.958-37.987 20.958-21.707 0-37.051-11.227-37.051-36.864V92.553l-4.678-4.678Zm139.792 65.87c-28.256 0-47.53-18.34-47.53-42.292s19.274-42.29 45.284-42.29c31.625 0 46.034 24.888 46.034 48.84h-67.74l-3.742 2.62c3.555 8.607 12.35 15.905 27.694 15.905 11.415 0 21.332-3.742 31.812-11.602l9.356 12.725c-13.848 11.04-27.508 16.094-41.168 16.094Zm19.461-50.525 1.684-3.93c-3.93-7.297-12.538-13.1-23.391-13.1-10.666 0-20.771 5.054-25.075 14.597l3.369 2.433h43.413Zm65.033 47.904H782.6v-79.34h19.087v8.98h4.491a34.145 34.145 0 0 1 25.636-11.6c18.713 0 32.186 11.414 32.186 32.559v49.402h-19.086V105.84c0-11.04-3.556-19.275-15.907-19.275-11.227 0-20.022 10.106-27.32 21.334v43.225ZM302.171 36.416h-21.168v21.168h21.168V36.416Z"
          />
          <path
            fill="currentColor"
            d="M71.986 44.467 60.893 33.762V0H43.774v33.681L32.585 44.467H0v17.561h32.663l11.111 10.698v33.654h17.119V72.725l11.093-10.697h32.891V44.467H71.986Z"
          />
        </svg>
      </Link>
    ),
    speakers: ['Josh Cirre', 'Leah Thompson', 'Joel Hooks'],
  },
  nx: {
    logo: (
      <Link
        href="https://bit.ly/4hGez7g"
        target="_blank"
        rel="noopener noreferrer"
      >
        <svg
