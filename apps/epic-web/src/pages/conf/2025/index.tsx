...
export const getStaticProps: GetStaticProps = async () => {
  ...
  return {
    props: {speakers: speakers, schedule: schedule},
    revalidate: 60 * 5,
  }
}
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-16">
        ...
        {community.length > 0 && (
          <div className="flex flex-col items-center gap-5 px-5 sm:flex-col sm:px-10">
            ...
            <div className="flex max-w-4xl flex-wrap items-center justify-center gap-8 sm:gap-x-16 sm:gap-y-5">
              {community.map(
                (s: {name: string; url: string; logo: React.JSX.Element}) => {
                  return (
                    <Link
...
const sponsorsData = {
  ...
  gold: [
    ...
    {
      name: 'Lingo.dev',
      url: 'https://lingo.dev/?utm_source=epicwebconf2025&utm_marketing=conf',
      logo: (
        <svg
          className="w-56"
          viewBox="0 0 409 71"
        ...
        >
          <path
            d="M0.144041 25.3614L25.9356 53.4988C26.0384 53.6094 26.1817 53.6745 26.3333 53.6745H68.6175C69.0993 53.6745 69.3397 53.0927 68.9987 52.7517L50.4416 34.1948H35.8324V41.4998L18.7876 24.4551H0.54175C0.0709926 24.4551 -0.175207 25.0151 0.144041 25.3614Z"
            fill="currentColor"
          />
          <path
            d="M69.0973 33.2909L43.303 5.15391C43.2 5.04297 43.0567 4.97803 42.9052 4.97803H0.620994C0.136708 4.97803 -0.104082 5.55974 0.236811 5.90064L18.7938 24.4576H33.4035V17.1528L50.4481 34.1975H68.6968C69.1676 34.1975 69.4137 33.6373 69.0944 33.2909H69.0973Z"
            fill="currentColor"
          />
          <path
            d="M284.958 53.9158H276.497V45.5288H284.958V53.9158Z"
            fill="currentColor"
          />
          <path
            d="M298.84 52.2039C296.213 50.5698 294.137 48.2655 292.606 45.2997C291.077 42.3338 290.301 38.962 290.301 35.2029C290.301 31.4436 291.066 28.0909 292.606 25.1439C294.137 22.1971 296.224 19.9113 298.84 18.2774C301.467 16.6434 304.385 15.8311 307.606 15.8311C312.308 15.8311 316.069 17.6162 318.892 21.177H319.259V1.9375H326.608V53.9136H320.3L319.554 49.1624H319.186C316.314 52.8273 312.45 54.6598 307.606 54.6598C304.385 54.6598 301.467 53.8475 298.84 52.2134V52.2039ZM313.878 46.2629C315.529 45.224 316.842 43.7412 317.815 41.805C318.78 39.8781 319.259 37.668 319.259 35.1934C319.259 32.7188 318.78 30.5276 317.815 28.6197C316.853 26.7118 315.54 25.2384 313.878 24.1994C312.216 23.1605 310.42 22.641 308.494 22.641C306.567 22.641 304.706 23.1605 303.072 24.1994C301.437 25.2384 300.134 26.7118 299.17 28.6197C298.208 30.5276 297.726 32.7188 297.726 35.1934C297.726 37.668 298.208 39.9347 299.17 41.8429C300.134 43.7507 301.437 45.224 303.072 46.2629C304.706 47.3021 306.51 47.8216 308.494 47.8216C310.477 47.8216 312.216 47.3021 313.878 46.2629Z"
            fill="currentColor"
          />
          <path
            d="M343.915 45.4028C346.182 47.0839 348.495 48.2644 351.414 48.2644C353.493 48.2644 355.324 47.7921 356.912 46.8572C358.498 45.9128 359.678 44.7039 360.473 43.221H368.122C366.98 46.5362 364.977 49.2751 362.106 51.4287C359.234 53.5823 355.675 54.6591 351.414 54.6591C347.948 54.6591 344.803 53.8274 341.989 52.1749C339.163 50.5219 336.954 48.2172 335.338 45.2706C333.733 42.3238 332.929 38.9707 332.929 35.2117C332.929 31.4524 333.733 28.1751 335.338 25.2282C336.945 22.2814 339.163 19.9862 341.989 18.3239C344.811 16.671 347.948 15.8398 351.414 15.8398C354.88 15.8398 357.732 16.6332 360.435 18.22C363.135 19.8068 365.26 21.9791 366.819 24.7559C368.378 27.5329 369.163 30.6497 369.163 34.1066C369.163 35.8348 369.04 37.1479 368.792 38.0451H340.251L346.37 32.4063H361.898C361.653 29.4407 360.558 26.985 358.631 25.0582C356.702 23.1314 354.294 22.1586 351.433 22.1586C348.572 22.1586 345.964 23.1219 343.934 25.0582C341.904 26.985 340.695 29.4407 340.297 32.4063C340.297 32.4063 338.73 41.587 343.934 45.4311L343.915 45.4028Z"
            fill="currentColor"
          />
          <path
            d="M393.879 53.9153H383.111L369.972 16.5698H377.7L387.795 45.604H389.28L399.375 16.5698H407.102L393.887 53.9153H393.879Z"
            fill="currentColor"
          />
          <path
            d="M145.532 9.51267H137.514V2.08887H145.532V9.51267ZM145.164 53.9136H137.816V16.5681H145.164V53.9136Z"
            fill="currentColor"
          />
          <path
            d="M153.254 53.9148V16.5692H159.564L160.31 20.4322H160.678C161.613 19.2421 163.049 18.1843 164.985 17.2398C166.912 16.2953 169.141 15.8325 171.672 15.8325C174.544 15.8325 177.103 16.4937 179.36 17.797C181.609 19.1099 183.375 20.9517 184.631 23.3319C185.896 25.712 186.52 28.4323 186.52 31.5017V53.9243H179.172V32.0968C179.172 29.4238 178.303 27.1949 176.574 25.4098C174.846 23.6246 172.692 22.7368 170.114 22.7368C168.386 22.7368 166.789 23.1618 165.325 24.0025C163.861 24.843 162.718 25.9859 161.868 27.4217C161.028 28.857 160.603 30.4156 160.603 32.0968V53.9243H153.254V53.9148Z"
            fill="currentColor"
          />
          <path
            d="M201.623 67.4964C199.073 66.1646 197.127 64.4932 195.795 62.4812C194.463 60.4698 193.746 58.4389 193.642 56.3519H201.065C201.264 58.08 202.208 59.6102 203.89 60.9132C205.571 62.2267 207.904 62.8779 210.869 62.8779C213.835 62.8779 216.385 62.0089 218.218 60.2808C220.05 58.5428 220.967 56.2475 220.967 53.3765V47.4356H220.598C219.313 48.8713 217.698 50.0138 215.771 50.8545C213.845 51.6951 211.71 52.1202 209.387 52.1202C206.166 52.1202 203.266 51.3551 200.66 49.8155C198.062 48.2852 196.022 46.132 194.539 43.3552C193.056 40.5877 192.31 37.4426 192.31 33.9291C192.31 30.4155 193.056 27.2799 194.539 24.5407C196.022 21.7922 198.062 19.6576 200.66 18.1181C203.257 16.588 206.166 15.8135 209.387 15.8135C211.767 15.8135 213.948 16.2858 215.96 17.2208C217.963 18.1653 219.587 19.4215 220.825 21.0083H221.193L221.939 16.5502H228.324V53.4521C228.324 56.6159 227.634 59.4118 226.246 61.8389C224.858 64.2665 222.846 66.1462 220.191 67.478C217.547 68.8188 214.44 69.48 210.869 69.48C207.299 69.48 204.173 68.8094 201.623 67.478V67.4964ZM215.724 43.9975C217.33 43.034 218.605 41.6741 219.55 39.9172C220.494 38.1606 220.957 36.1674 220.957 33.9386C220.957 31.7095 220.485 29.7354 219.55 27.9976C218.605 26.2691 217.33 24.9185 215.724 23.9551C214.118 22.9917 212.324 22.51 210.341 22.51C207.271 22.51 204.74 23.5773 202.728 25.7024C200.726 27.8275 199.724 30.576 199.724 33.9479C199.724 37.3197 200.726 40.1343 202.728 42.2596C204.73 44.3846 207.271 45.4519 210.341 45.4519C212.324 45.4519 214.118 44.9702 215.724 44.007V43.9975Z"
            fill="currentColor"
          />
          <path
            d="M243.235 52.1674C240.411 50.5144 238.201 48.2101 236.586 45.2632C234.98 42.3164 234.177 38.9634 234.177 35.2043C234.177 31.445 234.98 28.1677 236.586 25.2209C238.191 22.274 240.411 19.9789 243.235 18.3165C246.06 16.6636 249.195 15.8325 252.661 15.8325C256.128 15.8325 259.254 16.6636 262.05 18.3165C264.845 19.9789 267.046 22.274 268.661 25.2209C270.267 28.1677 271.069 31.4924 271.069 35.2043C271.069 38.9162 270.267 42.3164 268.661 45.2632C267.055 48.2101 264.845 50.5144 262.05 52.1674C259.254 53.8298 256.118 54.6516 252.661 54.6516C249.204 54.6516 246.05 53.8204 243.235 52.1674ZM258.262 46.2643C259.972 45.2253 261.322 43.7425 262.305 41.8063C263.296 39.8794 263.788 37.6694 263.788 35.1948C263.788 32.7202 263.296 30.5289 262.305 28.6211C261.313 26.7131 259.962 25.2398 258.262 24.2008C256.552 23.1618 254.682 22.6424 252.661 22.6424C250.64 22.6424 248.761 23.1618 247.06 24.2008C245.351 25.2398 244 26.7131 243.018 28.6211C242.026 30.5289 241.535 32.7202 241.535 35.1948C241.535 37.6694 242.026 39.8701 243.018 41.8063C244.009 43.733 245.36 45.2253 247.06 46.2643C248.77 47.3033 250.64 47.8228 252.661 47.8228C254.682 47.8228 256.562 47.3033 258.262 46.2643Z"
            fill="currentColor"
          />
          <path
            d="M133.081 53.3381H100.118V1.3623H107.91V45.9143L108.052 53.3381L116.222 45.9143H133.081V53.3381Z"
            fill="currentColor"
          />
        </svg>
      ),
  ...
  community: [
    ...
    {
      name: 'Handsontable',
      url: 'https://handsontable.com/docs/react-data-grid/?utm_source=EpicWeb2025&utm_medium=referral',
      logo: (
        <svg
          className="w-44"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1300 197.33459"
        >
          <path
            fill="currentColor"
            d="M50,108.21949H87.31046v49.44708h42.5603V108.21949h37.12505V237.71215H129.87076V186.644H87.31046v51.06813H50Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M182.72415,211.447c0-22.27079,18.838-30.96932,50.34767-30.96932h9.05876v-2.172c0-9.04817-2.172-15.03437-12.49686-15.03437-8.87335,0-12.13662,5.25514-12.85709,11.23075h-30.429c1.45152-22.82173,19.37834-34.04189,45.27793-34.04189,26.07971,0,42.74042,10.67981,42.74042,35.85364v61.3983H242.85634V226.66152c-4.52938,6.88678-12.86239,13.22262-28.07157,13.22262C197.75852,239.88414,182.72415,231.55643,182.72415,211.447Zm59.40643-6.87619v-5.79549h-8.51312c-13.0372,0-18.83269,2.53222-18.83269,10.31958,0,5.43526,3.6182,8.87865,11.22545,8.87865C235.2491,217.97358,242.13058,212.71844,242.13058,204.57084Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M292.81729,142.99243h32.42084v15.21449c5.06973-9.77923,15.38931-17.74671,31.14944-17.74671,18.29235,0,30.96932,11.41087,30.96932,35.67353v61.57841H354.93605V182.66029c0-10.69041-4.16386-15.94555-13.58285-15.94555-9.59912,0-16.11507,5.79549-16.11507,17.93742v53.06H292.81729Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M401.09337,191.34823V189.8967c0-32.23013,17.7467-49.43649,40.2082-49.43649,14.849,0,23.72231,6.33584,29.15757,15.935V101.33271h32.41555V237.71215H470.45914v-15.3946c-4.7095,9.77923-15.21449,17.56659-29.5231,17.56659C419.02548,239.88414,401.09337,224.1293,401.09337,191.34823Zm70.27165-.54035v-1.45152c0-15.93495-6.70137-24.45337-18.65788-24.45337-12.13133,0-18.65258,8.15818-18.65258,24.63348V190.988c0,15.935,7.0616,24.08255,18.29235,24.08255C464.118,215.07054,471.365,206.92294,471.365,190.80788Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M515.71059,207.64341h29.88333c1.086,6.88678,4.16915,10.6904,13.40273,10.6904,7.96748,0,11.591-3.08316,11.591-7.78736,0-4.52408-4.52408-6.70666-17.56659-8.50782-25.35394-3.26328-36.039-10.6904-36.039-30.429,0-21.01,18.65258-31.14944,40.56844-31.14944,23.36207,0,39.66255,7.96748,41.83454,30.6091H570.04728c-1.2714-6.34644-4.70949-9.419-12.13662-9.419-7.0616,0-10.68511,3.07256-10.68511,7.41653,0,4.53468,4.344,6.34643,15.93495,7.78736,26.26512,3.26328,38.9421,10.15006,38.9421,30.429,0,22.4615-16.66071,32.601-42.92583,32.601C532.19118,239.88414,516.43635,228.65339,515.71059,207.64341Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M611.14017,191.52834v-1.45152c0-30.41838,22.63632-49.61661,51.974-49.61661,29.16286,0,51.61906,18.64729,51.61906,48.716v1.45152c0,30.78921-22.64161,49.25638-51.79918,49.25638S611.14017,222.13743,611.14017,191.52834Zm70.63188-.54035v-1.45152c0-15.935-6.34113-24.8136-18.65787-24.8136-12.13133,0-18.8327,8.51842-18.8327,24.45337v1.45152c0,16.29518,6.34114,25.17383,18.8327,25.17383C675.2508,215.80159,681.77205,206.74283,681.77205,190.988Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M728.83525,142.99243H761.2561v15.21449c5.06973-9.77923,15.3893-17.74671,31.14943-17.74671,18.29235,0,30.96933,11.41087,30.96933,35.67353v61.57841H790.954V182.66029c0-10.69041-4.16385-15.94555-13.58285-15.94555-9.59911,0-16.11506,5.79549-16.11506,17.93742v53.06H728.83525Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M846.1648,207.28318V165.0831H834.75923V142.99243H846.1648V123.25386h32.42085v19.73857h18.65258V165.0831H878.58565v39.12751c0,6.87619,3.44339,9.95935,9.59911,9.95935a24.63418,24.63418,0,0,0,9.23888-1.63164V237.1718a68.33784,68.33784,0,0,1-17.93212,2.71234C858.12131,239.88414,846.1648,229.56456,846.1648,207.28318Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M906.82145,211.447c0-22.27079,18.838-30.96932,50.34766-30.96932h9.05876v-2.172c0-9.04817-2.172-15.03437-12.49685-15.03437-8.87336,0-12.13663,5.25514-12.85709,11.23075H910.445c1.45152-22.82173,19.37834-34.04189,45.27794-34.04189,26.0797,0,42.74041,10.67981,42.74041,35.85364v61.3983H966.95363V226.66152c-4.52938,6.88678-12.86238,13.22262-28.07157,13.22262C921.85582,239.88414,906.82145,231.55643,906.82145,211.447Zm59.40642-6.87619v-5.79549h-8.51312c-13.0372,0-18.83269,2.53222-18.83269,10.31958,0,5.43526,3.61821,8.87865,11.22545,8.87865C959.34639,217.97358,966.22787,212.71844,966.22787,204.57084Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
          ...
          <path
            fill="currentColor"
            d="M1134.24943,101.33271h32.23543V237.71215h-32.23543Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M1181.50863,191.52834v-1.45152c0-30.41838,22.63632-49.61661,51.25354-49.61661,25.89959,0,48.17568,14.84367,48.17568,48.89615v8.50782h-66.64814c.90587,12.50215,8.14759,19.74917,19.73857,19.74917,10.68511,0,15.21449-4.89491,16.4806-11.23075h30.429c-2.89774,21.37021-19.37834,33.50154-47.99556,33.50154C1203.23907,239.88414,1181.50863,222.49766,1181.50863,191.52834Zm67.91425-11.95121c-.54564-11.41087-6.15572-17.74671-16.66071-17.74671-9.77923,0-16.48059,6.33584-18.11223,17.74671Z"
            transform="translate(-50 -101.33271)"
          />
          <path
            fill="currentColor"
            d="M1295.33225,243.99954H1350v54.66775h-54.66775Z"
            transform="translate(-50 -101.33271)"
          />
        </svg>
      ),
    },
    {
      ...
      logo: (
        ...
        >
          <path
            d="M0 54.3455C0 71.6156 13.9429 85.5584 31.213 85.5584C48.3247 85.5584 62.426 71.6156 62.426 54.3455C62.426 37.2338 48.3247 23.1325 31.213 23.1325C13.9429 23.1325 0 37.2338 0 54.3455ZM133.725 11.0909C133.725 5.22857 138.636 0 144.816 0C150.995 0 156.223 5.22857 156.223 11.0909V74.4675C156.223 80.3299 150.995 85.5584 144.816 85.5584C138.636 85.5584 133.725 80.3299 133.725 74.4675V11.0909ZM8.23896 101.086C9.50649 112.018 18.5377 122 31.213 122C43.7299 122 53.0779 112.018 54.3455 101.086C56.0883 85.2416 41.6701 90.4701 31.213 90.4701C20.7558 90.4701 6.4961 85.2416 8.23896 101.086ZM108.849 58.7818C109.958 56.2468 112.81 54.6623 118.356 54.6623C127.07 54.5039 130.556 48.8 125.961 39.7688C122.792 33.5896 117.881 28.8364 111.226 25.826C95.5403 18.8545 77.0026 25.9844 70.0312 41.6701C63.0597 57.1974 70.0312 75.7351 85.8753 82.8649C92.5299 85.7169 99.1844 86.1922 105.997 84.4493C115.821 81.7558 117.881 75.2597 112.018 68.7636C108.374 64.4857 107.582 61.4753 108.849 58.7818Z"
            fill="currentColor"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      logo: (
        <svg
          className="w-20"
          viewBox="0 0 1583 683"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <g>
            <path
              d="M748.69 601.861C603.784 601.861 530.06 517.12 530.06 411.195C530.06 285.779 630.053 172.227 774.959 172.227C919.865 172.227 993.59 256.968 993.59 362.893C993.59 488.309 893.596 601.861 748.69 601.861ZM754.622 467.124C805.466 467.124 837.667 421.364 837.667 370.52C837.667 329.844 811.398 306.964 769.028 306.964C718.183 306.964 685.982 352.724 685.982 403.568C685.982 444.244 712.252 467.124 754.622 467.124Z"
              fill="white"
            />
            <path
              d="M1147.94 591.692H995.41L1119.98 26.474H1272.51L1147.94 591.692Z"
              fill="white"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M298.97 601.861C252.363 601.861 206.603 584.913 180.334 548.474L171.068 591.449L0 682.329L18.4676 591.449L143.048 26.474H295.581L251.516 225.614C287.107 186.633 320.155 172.227 362.526 172.227C454.045 172.227 515.058 232.393 515.058 342.555C515.058 456.107 444.724 601.861 298.97 601.861ZM357.441 374.757C357.441 427.296 320.155 467.124 271.853 467.124C244.737 467.124 220.162 456.955 204.061 439.159L227.789 334.929C245.584 317.133 265.922 306.964 289.649 306.964C326.087 306.964 357.441 334.081 357.441 374.757Z"
              fill="white"
            />
            <path
              d="M1431.21 601.861C1343.08 601.861 1280.37 569.659 1280.37 498.478C1280.37 492.546 1281.22 478.14 1283.76 466.276L1316.81 314.591H1249.02L1278.67 182.396H1346.47L1371.04 70.539L1541.8 0L1523.58 70.7114L1499 182.396H1582.04L1552.39 314.591H1469.34L1447.31 414.585C1445.61 422.211 1444.77 430.685 1444.77 434.075C1444.77 453.565 1456.63 467.124 1482.9 467.124C1490.53 467.124 1501.54 464.581 1504.08 462.887V584.913C1487.98 595.929 1459.17 601.861 1431.21 601.861Z"
              fill="white"
            />
          </g>
        </svg>
    ...
    {
      name: 'Charlie',
      url: 'https://www.charlielabs.ai/',
      logo: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8"
          fill="none"
          viewBox="0 0 2787 697"
        >
          <path
            fill="currentColor"
            d="M2786.26 472.37h-57.98v60.92h57.98v-60.92ZM290.94.28 630.51 0c87.74 10.81 122.95 110.7 60.02 174.78-44.47 45.28-93.31 86.66-137.99 131.79-17.62 19.39-20.64 47.97-8 70.94 38.43 44.27 84 82.67 126 123.79 22.4 21.93 43.43 39.41 49.99 71.9 12.15 60.11-30.59 117.76-91.96 121.92-110.63-3.93-224.73 5.09-334.96 0C136.79 687.87 8.6 559.58 1.21 403c-1.61-34.1-1.61-76.84 0-110.94C8.55 136.62 135.43 8.69 290.94.28Zm61.96 97.86c-61.77 7.35-45.3 104.73 17.99 87.89 51.97-13.83 37.36-94.47-17.99-87.89Zm195.93 1.99c-61.77 7.35-45.3 104.73 17.99 87.89 51.97-13.83 37.36-94.47-17.99-87.89Zm1869.56 277.36c3.26 51.89 32.93 100.65 86.15 112.17 48.01 10.39 110.36-7.25 120.77-61.24h52.98c-8.84 58.2-55.61 96.26-111.78 106.54-132.15 24.19-222.3-85.86-194.43-212.22 18.55-84.11 88.53-129.76 173.63-119.9 83.98 9.74 134.91 79.28 129.57 162.15-.23 3.6-.78 9.87-2.49 12.49h-254.41l.01.01Zm203.92-41.94c-2.83-31.48-16.56-60.71-44.68-76.7-26.04-14.81-62.98-16.84-91.23-7.64-37.01 12.04-59.95 46.77-65.02 84.35h200.93v-.01ZM1818.6 533.29h-51.98v-55.93l-15.48 22.98c-59.9 63.59-203.5 49.04-209.48-53.4-3.35-57.45 36-93.63 89.18-104.74 38.97-8.14 78.84.19 117.17-3.78 20.08-2.08 20.25-15.38 17.48-32.19-4.29-25.96-22.6-46.19-47.31-54.61-49.44-16.83-119.41 1.41-127.49 59.96h-47.48c-1.07 0-1.49-2.19-1.44-3.34.8-18.41 14.08-44.16 25.96-58.05 71.59-83.69 247.4-58.67 250.93 66.84l-.05 216.26h-.01Zm-51.98-155.8c-31.74 1.32-64.88-1.76-96.46.02-35.12 1.97-72.79 17.47-75.35 57.54-4.19 65.51 82.8 69.97 125.49 45.49 36.52-20.95 48.07-63.14 46.32-103.04v-.01ZM1250.8 72.89v194.74l7.19-14.29c63.91-96.5 220.76-51.35 221.72 66.73v213.21h-51.97l.04-202.27c-12.71-121.87-169.58-101.57-177.02 14.98l.04 187.3h-51.98V72.89h51.98Zm-111.96 243.68h-50.98c-14.16-70.25-114.68-88.26-164.41-44.91-52.58 45.83-50.92 163.38 8.56 203.11 50.74 33.9 139.09 17.08 155.85-47.35h50.98c-5.59 29.56-19.05 56.68-41.97 76.41-37.68 32.43-99.55 41.27-146.97 29.95-154.16-36.79-157.9-281.35-7.76-325.34 82.19-24.08 184.91 16.01 196.69 108.12l.01.01ZM2173.47 72.89v460.4h-50.48l-1.5-1.5V72.89h51.98Zm-232.91 133.83v63.92l10.48-22.99c26.24-46.24 72.72-41.38 119.48-40.93v45.94c-38.19.9-75.61-7.14-102.99 25.44-21.04 25.05-24.18 61.52-26.96 92.91v162.28h-51.99V206.72h51.98Zm366.87 0h-51.98v326.57h51.98V206.72Zm4-133.83v71.41l-1.5 1.5h-58.48V72.89h59.98Z"
          />
        </svg>
      ),
    },
      ...
      logo: (
        ...
        >
          <path
            fill="currentColor"
            fillRule="evenodd"
            d="M78.31 32.476h7.058a.324.324 0 0 0 .338-.338 3.597 3.597 0 0 0-3.834-3.672 3.672 3.672 0 0 0-3.9 3.672.325.325 0 0 0 .338.338Zm3.533 7.498c1.763 0 3.092-.881 3.496-2.137a.733.733 0 0 1 .778-.58h1.733a.543.543 0 0 1 .58.675c-.403 2.938-3.055 5.09-6.61 5.09a6.742 6.742 0 0 1-6.91-6.44 36.895 36.895 0 0 1 0-4.753 6.742 6.742 0 0 1 6.955-6.448c4.105 0 6.786 2.549 6.786 6.786v2.35a.683.683 0 0 1-.676.676h-9.73a.324.324 0 0 0-.339.338c-.007 3.084 1.594 4.443 3.937 4.443Zm20.461-2.82a.565.565 0 0 1 .646-.58h1.763a.683.683 0 0 1 .676.676c0 3.29-2.747 5.772-6.551 5.772-4.076 0-6.515-2.886-6.786-6.448a37.15 37.15 0 0 1 0-4.752c.271-3.561 2.717-6.448 6.786-6.448 3.804 0 6.551 2.475 6.551 5.773a.604.604 0 0 1-.581.676h-1.836a.58.58 0 0 1-.646-.544c0-1.594-1.395-2.85-3.496-2.85a3.536 3.536 0 0 0-3.73 3.393 36.895 36.895 0 0 0 0 4.752 3.532 3.532 0 0 0 3.73 3.393c2.086.007 3.474-1.212 3.474-2.813Zm7.667 5.538a.683.683 0 0 1-.676-.676V19.374a.683.683 0 0 1 .676-.676h1.697a.682.682 0 0 1 .675.676v6.147c0 .405.329.734.735.734.675 0 1.564-.852 3.121-.852a6.447 6.447 0 0 1 6.448 6.427v10.179a.683.683 0 0 1-.676.675h-1.696a.683.683 0 0 1-.676-.675v-10.18a3.525 3.525 0 0 0-3.628-3.392c-2.108 0-3.635 1.468-3.635 3.224v10.348a.683.683 0 0 1-.676.675l-1.689.008Zm26.512-6.111c.103-1.582.103-3.17 0-4.751a3.943 3.943 0 0 0-7.806 0 36.931 36.931 0 0 0 0 4.752 3.942 3.942 0 0 0 7.806 0Zm3.056-4.751a36.931 36.931 0 0 1 0 4.752 6.977 6.977 0 0 1-13.918 0 36.931 36.931 0 0 1 0-4.752 6.978 6.978 0 0 1 13.918 0Zm4.817 10.766a.733.733 0 0 1-.734.507h-.734a.639.639 0 0 1-.544-.947l9.746-23.061a.639.639 0 0 1 .646-.507h.735a.656.656 0 0 1 .543.948l-9.658 23.06Zm23.766-6.015a36.93 36.93 0 0 0 0-4.751 3.944 3.944 0 0 0-7.807 0 36.93 36.93 0 0 0 0 4.751 3.945 3.945 0 0 0 7.807 0Zm-7.344 5.332a1.28 1.28 0 0 0-.852.544.644.644 0 0 1-.477.235h-1.153a.682.682 0 0 1-.683-.676V19.374a.682.682 0 0 1 .683-.676h1.696a.683.683 0 0 1 .676.676v6.007c0 .647.235.852.734.852.676 0 1.594-.852 3.158-.852 3.562 0 6.177 2.887 6.449 6.449a36.93 36.93 0 0 1 0 4.751c-.272 3.562-2.887 6.448-6.449 6.448-2.489 0-2.798-1.116-3.782-1.116Zm22.415-20.336a.538.538 0 0 1-.544.543h-2.306a.534.534 0 0 1-.543-.543v-2.343a.557.557 0 0 1 .543-.543h2.306a.559.559 0 0 1 .544.543v2.343Zm-7.668 7.028a.682.682 0 0 1-.675-.675v-1.535a.679.679 0 0 1 .675-.69h6.889c.375 0 .679.3.683.675v13.088a.324.324 0 0 0 .338.337h4.311a.683.683 0 0 1 .676.676v1.528a.684.684 0 0 1-.676.675h-12.559a.682.682 0 0 1-.675-.675V40.48a.682.682 0 0 1 .675-.676h4.444a.32.32 0 0 0 .243-.094.32.32 0 0 0 .094-.243V28.943a.32.32 0 0 0-.094-.243.32.32 0 0 0-.243-.095h-4.106Zm22.767-3.224a6.34 6.34 0 0 1 6.448 6.448v10.18a.683.683 0 0 1-.676.675h-1.696a.684.684 0 0 1-.676-.675v-10.18c0-1.968-1.63-3.393-3.731-3.393-2.1 0-3.73 1.256-3.73 3.225v10.347a.683.683 0 0 1-.683.676h-1.719a.683.683 0 0 1-.676-.675V26.394a.683.683 0 0 1 .676-.676h1.469a.655.655 0 0 1 .477.235c.198.29.505.486.852.544 1.006 0 1.278-1.117 3.665-1.117Zm19.976 11.2a36.93 36.93 0 0 0 0-4.751 3.943 3.943 0 0 0-7.807 0 37.295 37.295 0 0 0 0 4.751 3.945 3.945 0 0 0 7.807 0Zm-10.693 0a37.295 37.295 0 0 1 0-4.751c.272-3.562 2.886-6.449 6.448-6.449 1.564 0 2.475.852 3.158.852.507 0 .735-.205.735-.852v-6.007a.683.683 0 0 1 .675-.676h1.733a.683.683 0 0 1 .676.676v22.635a.683.683 0 0 1-.676.675h-1.175a.648.648 0 0 1-.477-.235 1.283 1.283 0 0 0-.852-.543c-.984 0-1.292 1.116-3.804 1.116-3.555.007-6.177-2.879-6.441-6.44Z"
            clipRule="evenodd"
          />
          <path
            fill="currentColor"
            d="M32.508 61.647h-3.326C12.92 60.783 0 47.323 0 30.845 0 13.81 13.81 0 30.845 0a30.843 30.843 0 0 1 30.846 30.845c0 16.478-12.92 29.938-29.183 30.802ZM45.35 32.439a7.03 7.03 0 0 1 .852 4.098 7.182 7.182 0 0 1-7.212 6.382h-9.048a.207.207 0 0 1-.19-.134.207.207 0 0 1 .058-.226 11.02 11.02 0 0 0 2.592-3.473.462.462 0 0 1 .412-.28h6.36a2.938 2.938 0 0 0 2.937-3.341c-.19-1.469-1.065-2.563-2.453-2.563h-4.333a.301.301 0 0 1-.279-.412l1.47-3.334c.087-.22.308-.367.94-.367h5.294a3.026 3.026 0 0 0 3.033-2.563 2.938 2.938 0 0 0-2.937-3.342H40.34c-4.134 0-5.78 3.716-7.469 7.961C30.56 36.45 28.525 42.92 20.924 42.92h-1.888a7.197 7.197 0 0 1-7.285-6.86 7.065 7.065 0 0 1 4.568-6.807 7.024 7.024 0 0 1-.852-4.098 7.182 7.182 0 0 1 7.212-6.382h9.07a.206.206 0 0 1 .132.36 11.02 11.02 0 0 0-2.593 3.473.463.463 0 0 1-.41.28h-6.36a2.937 2.937 0 0 0-2.939 3.34c.191 1.47 1.065 2.564 2.453 2.564h4.334a.3.3 0 0 1 .28.411l-1.47 3.335c-.088.22-.309.367-.94.367h-5.303a3.025 3.025 0 0 0-3.033 2.563 2.939 2.939 0 0 0 2.938 3.341h2.511c4.135 0 5.78-3.716 7.47-7.96 2.313-5.604 4.347-12.074 11.948-12.074h1.888a7.197 7.197 0 0 1 7.285 6.86 7.066 7.066 0 0 1-4.59 6.807ZM30.845 57.58c14.758-.017 26.717-11.976 26.733-26.734 0-14.764-11.969-26.732-26.733-26.732-14.764 0-26.732 11.968-26.732 26.732 0 14.765 11.968 26.733 26.732 26.733Z"
          />
        </svg>
      ),
    },
