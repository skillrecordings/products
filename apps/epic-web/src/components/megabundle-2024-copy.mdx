...
For one low price, you can learn the ins & outs of Epic Web Development, from the basics of React to shipping full scale production web applications — Not just the technologies and techniques, you'll also learn the why, the principles I've used to pick the right problems, choose the right tools, architect my projects in a way that lasts…

**Enroll by Dec 1 and you'll save {Number(props.commerceProps.couponFromCode?.percentageDiscount) * 100}% on the most complete collection of developer workshops ever by me, Kent C. Dodds:**
...
<WorkshopListItem children="Advanced Vitest Patterns" imageUrl="https://cdn.sanity.io/images/i1a93n76/production/f7e3d7d80e35a95bf725b6b09513166dc354eb9b-424x424.png" />
<WorkshopListItem children="React Component Testing with Vitest" imageUrl="https://res.cloudinary.com/epic-web/image/upload/v1746742430/react-component-testing-with-vitest-browser-mode-minified_2x.png" />
...
**But this special offer ends at Midnight (Pacific) on Monday, December 1st**

So now is the perfect time to spend down your remaining 2025 learning budget, and invest in your skills, knowledge, and career in 2026. ([Here's a page to send your boss](/boss).)
...
## Not sure if this deal is right for you? Let's talk about how the epic Epic Megabundle can change your entire career…
...
These are the timeless tools of an expert, the ones you'll always need no matter what language and frameworks you use in the future… In fact, I'm so proud of the way that the lessons in Epic Web, especially, go so far beyond the tools list on the curriculum. So many students have written to tell me, "I may not use Remix like you do, but what I learned has changed the way I write code with Next.js."
...
Better than a course you take once and forget most of it, The Epic Megabundle becomes their go-to reference, for when building new apps and tackling new challenges.
...
This Epic Megabundle meets you where you are:
...
- Use it or lose it: the Epic Megabundle is a perfect way to spend down your remaining 2025 learning budget.
- Need to talk to your boss? [This page will help](https://www.epicweb.dev/boss).
- Get ready to develop mastery in 2025.
- Save {Number(props.commerceProps.couponFromCode?.percentageDiscount) * 100}%
- Offer ends Monday, December 1st at Midnight (Pacific)
