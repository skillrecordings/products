...
<div className="mt-5">
  <h2 className="mx-auto mb-0 w-full max-w-2xl border-t border-white/10 pb-0 text-3xl sm:pt-10 sm:text-4xl lg:pt-16 lg:text-5xl">
    <Balancer>
      {
...
<p className="pb-10 pt-10 text-center">{'A lot of them!'}</p>
...
<div className="lg:pt-16 sm:pt-10 sm:mt-16 lg:mt-20 pt-5 mt-10 border-t max-w-2xl mx-auto dark:border-gray-800 border-gray-200">
