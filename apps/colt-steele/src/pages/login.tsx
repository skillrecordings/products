...
> = ({csrfToken, providers = {}}) => {
  ...
  return (
    <Layout footer={null} meta={{title: 'Log in'}}>
      <div className="relative mx-auto flex w-full flex-grow flex-col items-center sm:justify-center justify-start sm:pb-16 pb-10 px-5 sm:pt-0 pt-14">
        <main className="relative z-10 max-w-xl w-full mx-auto">
          <h1 className="text-center font-text text-4xl font-bold font-heading sm:text-5xl">
            Log In
          </h1>
          ...
          <div className="pt-8 sm:mx-auto sm:w-full sm:max-w-md sm:pt-10">
            <form method="post" action="/api/auth/signin/email">
              ...
              <button className="focus-visible:outline-black/80 hover:brightness-110 transition bg-brand-red text-white rounded-md px-8 py-4 w-full font-semibold">
